...
void hal_entry(void)
{
    ...
    while (1)
    {
        ...
        sprintf (write_buffer, "test %d \n\r", findMax(p_ob1203_data.green_data, p_ob1203_data.red_data, p_ob1203_data.blue_data));
        console_write (write_buffer);
        ...
        switch (findMax(p_ob1203_data.green_data, p_ob1203_data.red_data, p_ob1203_data.blue_data))
        {
            case 1:
            {
//                LED1
